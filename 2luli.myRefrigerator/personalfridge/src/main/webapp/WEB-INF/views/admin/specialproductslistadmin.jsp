	...
	rel="stylesheet">
     ...
     <!-- Navbar start -->
       <%@ include file="../header.jsp" %>
		...
		.special-product {
		    background-color: orange; /* 특가 상품 배경색: 빨간색 */
           ...
           <c:forEach var="product" items="${productlist}">
                <div class="card">
                   <div class="card-head"> <!-- 수정 및 삭제 버튼을 포함할 요소 -->
                        <div class="special-product">특가 상품</div>
                        <div class="cardbtn">
...
<script>
	$(document).ready(function() {
     ...
     // 검색 버튼 클릭 및 엔터 키 이벤트를 바인딩
        ...
        function getSpeicalProductsAll(page) {
        ...
        function updateProducts(response) {
            ...
            $.each(response.products, function(index, product) {
                ...
                var productType = '<div class="special-product">특가 상품</div>';
                var productHTML = '<div class="card">' +
                    '<div class="special">' + productType + '</div>' +
                    '<div class="card-info">' +
                    '<div class="product-id" style="display: none;">' + product.product_id + '</div>' +
       				'<div class="product-name" style="display: none;">' + product.product_name + '</div>' +
                    '<a>' + product.product_name + '</a>' +
