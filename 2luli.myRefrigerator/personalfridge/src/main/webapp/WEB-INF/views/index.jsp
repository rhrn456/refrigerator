...
<html>
											    ...
											    <div class="col-md-6 col-lg-4 col-xl-3" style="display: ${count < 4 ? 'block' : 'none'};">
											        <div class="rounded position-relative fruite-item">
											            ...
											            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
											                ...
											                <div class="d-flex justify-content-between flex-lg-wrap" style="margin-left:50px;">
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="p-4 rounded-bottom">
                        ...
                        <div class="d-flex justify-content-between flex-lg-wrap">
                            <p class="text-dark fs-5 fw-bold mb-0">${ProductDTO.product_price}원</p>
                            <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        $('.col-md-6:gt(3)').hide(); // 처음 4개를 제외한 아이템들을 숨김
    });
    </script>
    </body>
</html>
