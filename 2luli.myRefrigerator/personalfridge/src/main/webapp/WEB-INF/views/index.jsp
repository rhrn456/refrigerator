				...
				<c:forEach var="ProductDTO" items="${products}">
					<div
						...
						<div
							...
							style="top: 10px; right: 10px; background-color: #ffb524 !important;">${ProductDTO.product_category}</div>
						<div
							class="p-4 border border-secondary border-top-0 rounded-bottom">
							<h6
							...
							<div class="d-flex justify-content-between flex-lg-wrap">
								...
								<a href="#"
									...
									class="fa fa-shopping-bag me-2 text-primary"></i>장바구니 담기
								</a>
							</div>
						</div>
					</div>
					...
					<form class="row g-3">
						...
						<div class="col-12">
							<button type="button" class="btn btn-primary"
								style="float: right; margin-top: -20px;" id="addToCartBtn">장바구니에
								추가</button>
						</div>
					</form>
				</div>
...
>>>>>>> origin/feature/refrigerator
	...
	<script>
		...
		$(document).on(
				...
				'.buyproduct',
				function() {
					var productId = $(this).closest('.fruite-item').find(
							'.product-id').text().trim();
					var productName = $(this).closest('.fruite-item').find(
