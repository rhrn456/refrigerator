    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            ...
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item active text-white">냉장고 식량 창고</li>
                <li class="breadcrumb-item"><a href="/specialproductshop">알뜰 쇼핑</a></li>
            </ol>
        </div>
							                        ...
							                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
							                           ...
							                           <a>${product.product_content}</a><br>
							                            ...
							                            <div class="d-flex justify-content-between flex-lg-wrap">
							                                <p class="text-dark fs-5 fw-bold mb-0" style="margin-top:18px;">${product.product_price}원</p>
