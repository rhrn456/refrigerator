 ...
 <head>
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">냉장고 식량 창고</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item active text-white" style="font-size:20px; font-weight:bold;">냉장고 식량 창고</li>
                <li class="breadcrumb-item"><a href="/specialproductshop" style="font-size:20px; font-weight:bold; color: #fc9a9a !important;">알뜰 쇼핑</a></li>
            </ol>
        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-3">
                                <div class="row g-4">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <h3 style="margin-bottom:0.5rem;">카테고리</h3>
							        ...
							        <c:forEach var="product" items="${products}" >
							                <div class="col-md-6 col-lg-6 col-xl-4">
							                    <div class="rounded position-relative fruite-item">
							                        ...
							                        <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px; font-weight:bold; font-size:17px; background-color: #dc2e5e  !important;">${product.product_category}</div>
