 ...
 <head>
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">특가 상품</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="/productshop">식재료</a></li>
                <li class="breadcrumb-item active text-white">특가 상품</li>
            </ol>
        </div>
